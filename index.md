...
<div style="float: left; width: 65%; padding-right: 5%; @media only screen and (max-width: 780px) { float: none; }">
    ...
    <p>Currently pursuing a master's degree in Media Informatics at Dresden University of Technology (TUD) and serving there as a Student Assistant for Professor Gerhard Weber's courses of Human Computer Interaction and Introduction to Media Informatics. In the summer of 2023, I completed my B.Sc. in Computer Science and Computational Linguistics at Ludwig Maximilian University (University of Munich).</p>
